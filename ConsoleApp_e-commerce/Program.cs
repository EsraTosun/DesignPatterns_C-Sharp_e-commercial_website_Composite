     ...
     class Program
    {
        ...
        static void SavedDressData()    //Kayıtlı Ürün Veriler
        {
           /* (int UserId, int ID, String brand, int amount, String color, String productsType,
            ...
            Products products = new Dress(200,1000, 
            ...
            Products products1 = new Dress(201, 1001,
                Enum.GetName(typeof(BrandType), 0),
                100,
                ...
                Enum.GetName(typeof(BodyType), 2),
                Enum.GetName(typeof(FabricType), 3));
            Products products2 = new Dress(202, 1002,
            ...
            Products products3 = new Dress(203, 1003,
            ...
            Products products4 = new Dress(200, 1004,
                Enum.GetName(typeof(BrandType), 0),
                100,
                Enum.GetName(typeof(ColorType), 3),
                Enum.GetName(typeof(ProductsType), 3),
            ...
            canvas.ProductsListAdd(products);
            canvas.ProductsListAdd(products1);
            canvas.ProductsListAdd(products2);
            canvas.ProductsListAdd(products3);
            canvas.ProductsListAdd(products4);
        }

        static void SavedTshirtData()    //Kayıtlı Ürün Veriler
        {
            Products products = new Tshirt(201, 1005,
                ...
                Enum.GetName(typeof(BodyType), 1),
                Enum.GetName(typeof(FabricType), 2));
            Products products1 = new Tshirt(202, 1006,
                Enum.GetName(typeof(BrandType), 3),
                100,
                Enum.GetName(typeof(ColorType), 1),
                Enum.GetName(typeof(ProductsType), 2),
                ...
                Enum.GetName(typeof(BodyType), 1),
                Enum.GetName(typeof(FabricType), 2));
            Products products2 = new Tshirt(203, 1007,
                Enum.GetName(typeof(BrandType), 3),
                100,
                Enum.GetName(typeof(ColorType), 3),
                Enum.GetName(typeof(ProductsType), 2),
                ...
                Enum.GetName(typeof(BodyType), 1),
                Enum.GetName(typeof(FabricType), 1));
            Products products3 = new Tshirt(200, 1008,
                Enum.GetName(typeof(BrandType), 0),
                100,
                Enum.GetName(typeof(ColorType), 2),
                Enum.GetName(typeof(ProductsType), 2),
                ...
                Enum.GetName(typeof(BodyType), 3),
                Enum.GetName(typeof(FabricType), 1));
            Products products4 = new Tshirt(201, 1009,
                Enum.GetName(typeof(BrandType), 1),
                100,
                Enum.GetName(typeof(ColorType), 1),
                Enum.GetName(typeof(ProductsType), 2),
        ...
        static void SavedPantsData()    //Kayıtlı Ürün Veriler
        {
            ...
            Products products = new Pants(202, 1010,
                Enum.GetName(typeof(BrandType), 1),
                100,
                Enum.GetName(typeof(ColorType), 2),
                ...
                Enum.GetName(typeof(BodyType), 2),
                Enum.GetName(typeof(FabricType), 1));
            Products products1 = new Pants(203, 1011,
                Enum.GetName(typeof(BrandType), 1),
                100,
                Enum.GetName(typeof(ColorType), 1),
                Enum.GetName(typeof(ProductsType), 1),
                ...
                Enum.GetName(typeof(BodyType), 1),
                Enum.GetName(typeof(FabricType), 1));
            Products products2 = new Pants(200, 1012,
                Enum.GetName(typeof(BrandType), 2),
                100,
                Enum.GetName(typeof(ColorType), 2),
                Enum.GetName(typeof(ProductsType), 1),
                ...
                Enum.GetName(typeof(BodyType), 2),
                Enum.GetName(typeof(FabricType), 2));
            Products products3 = new Pants(201, 1013,
                Enum.GetName(typeof(BrandType), 3),
                100,
                Enum.GetName(typeof(ColorType), 3),
                Enum.GetName(typeof(ProductsType), 1),
            ...
            Products products4 = new Pants(202, 1014,
