...
namespace ConsoleApp_e_commerce
{
    ...
    abstract class Products : IProducts  //Ürünler
    {
        ...
        public abstract void ProductAdd();
        ...
        public static void ProductAddd()
        {
            Products product = new Canvas();
            ...
            Canvas.productList.Add(product);
        }  
